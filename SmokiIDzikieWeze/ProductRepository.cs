...
namespace SmokiIDzikieWeze
{
    public class ProductRepository
    {
        ...
        Product product4 = new Ebook("Pod kluczem", 27.9, "Diabolicznie zmyślna. Pokręcona i pełna zwrotów akcji. Trzymajcie w pogotowiu jakiś koc, będziecie mieć dreszcze", 300);
